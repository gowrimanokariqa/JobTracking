...
public class Cutting extends Base {
	@Test(priority=0)
	...
	@Test(priority=1)
	public void adminLoginFloorApp(){
		WebElement username = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText[1]"));
		username.click();
		...
		WebElement toast = driver.findElement(By.xpath("(//android.widget.Toast)[1]"));
		String toastMsg = toast.getAttribute("text");
		Assert.assertEquals(toastMsg, "Admin can not use this app");
	}
	...
	public void validLogin() {
		...
		WebElement login = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Log In\"]"));
		login.click();
		String userName = driver.findElement(By.xpath("//android.view.View[@content-desc=\"lisette\"]")).getAttribute("content-desc");
		Assert.assertEquals(userName, "lisette");
	}
	@Test(priority=3)
	...
	public void emptyBarcode() {
		...
		WebElement toast = driver.findElement(By.xpath("(//android.widget.Toast)[1]"));
		String toastMsg = toast.getAttribute("text");
		Assert.assertEquals(toastMsg,"please enter barcode");
	}
	@Test(priority=6)
	public void assignedindividualBarcode() {
		WebElement barCode = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText"));
		barCode.click();
		barCode.sendKeys("187-2170-1-3904");
		driver.navigate().back();
		driver.findElement(By.xpath("//android.view.View[@content-desc=\"FETCH\"]")).click();
	...
	@Test(priority=8)
	public void cuttingLogout() {
		driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.ImageView[2]")).click();
		...
		WebElement homeScreen=driver.findElement(By.xpath("//android.view.View[@content-desc=\"WELCOME !\"]"));
		boolean homeEnabled =homeScreen.isEnabled();
		Assert.assertEquals(homeEnabled, true);
